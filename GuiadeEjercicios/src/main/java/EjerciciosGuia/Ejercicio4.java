...
public class Ejercicio4 {
	...
	public static void Ej4a() {
		...
		while(seguir == 1) {
			...
			numero = Integer.parseInt(funciones.leer());
			if(numero != -99) {
				numeros.add(numero);
			}else{
				seguir = 0;
		...
		funciones.mostrarResultado(numeros);
	}
	...
	public static void Ej4b() {
        ...
        colegio.addAlumno("Romaniello", "Italia");
        colegio.addAlumno("Gonzales", "España");
        colegio.addAlumno("Alavrez", "España");
        colegio.addAlumno("Messi", "italia");
        colegio.addAlumno("Fernandez", "Argentina");
        colegio.addAlumno("Gimenez", "España");
        colegio.addAlumno("Modric", "Croacia");
        colegio.addAlumno("Putin", "Rusia");
        colegio.addAlumno("Mendez", "España");
	...
	public static void Ej4d() {
        ...
        funciones.imprimirElementos(jugadores);
	...
	public static void Ej4e() {
        ...
        int[] numerosRojos = funciones.generarNumerosRojos(6);
        int numeroAzul = funciones.generarNumeroAleatorio(1, 16);
	...
	public static void Ej4g() {
        ...
        // Obtener los datos a través de entrySet
        ...
        // Obtener los datos a través de keySet
